...
# Interior Wall - Living Room / Kitchen
interior_wall_x = -1.5
...
# Basement Ceiling (Ground floor basement area)
...
# TV Screen
tv_screen = create_plane('TV_Screen', (0.45, 0.3, 1), (tv_x, tv_y - 0.2, ground_y + 0.65), rotation=(0, -math.radians(90), 0), material=materials['glass'])
...
# Reg the stuffed rabbit (abstract)
...
# Leo's Body (story element - abstract representation)
